...
Content queues are used to manually review and act on content submitted to your projects. You can configure what content you want in the queue by setting up filters.<br />

The queues are optional to use, but they are useful as your own customizable moderation dashboard.<br />
...
The wordlists are smart and can be used to add words with different variations. For example, if you add the word `run` to a wordlist, the model will also recognize `running` and `ran`.<br />
