...
<Card
  ...
  icon="users"
  href="https://dash.moderationapi.com/users"
>
...
```javascript
const response = await fetch("https://api.moderationapi.com/v1/moderate/text", {
  method: "POST",
...
When you identify problematic users, take action from the [user dashboard](https://dash.moderationapi.com/users):
