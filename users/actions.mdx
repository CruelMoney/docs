...
Actions can be executed manually from the [user dashboard](https://dash.moderationapi.com/users) or programmatically via the [Author API](/api-reference/author). They complement content moderation by addressing the user behind the content, helping you stop persistent abuse and enforce community standards.
...
1. Navigate to the user detail page in the [user dashboard](https://dash.moderationapi.com/users)
