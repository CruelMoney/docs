...
const blockResponse = await fetch("/api/v1/actions/execute", {
  method: "POST",
  headers: { 
...
const suspendResponse = await fetch("/api/v1/actions/execute", {
  method: "POST", 
  headers: { 
    "Authorization": "Bearer YOUR_API_KEY",
    "Content-Type": "application/json"
...
const unblockResponse = await fetch("/api/v1/actions/execute", {
  method: "POST",
  headers: { 
    "Authorization": "Bearer YOUR_API_KEY",
    "Content-Type": "application/json"
