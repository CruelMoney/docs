...
You might also want to check what your peak usage is for a given time period. You can do in the [analytics page](https://dash.moderationapi.com/analytics) in your dashboard. Check the Peak RPM chart. This is useful to see if you are close to hitting your rate limit.
