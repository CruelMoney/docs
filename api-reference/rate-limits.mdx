...
You might also want to check what your peak usage is for a given time period. You can do in the [analytics page](https://moderationapi.com/app/analytics) in your dashboard. Check the Peak RPM chart.
