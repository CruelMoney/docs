...
Different plans have different rate limit tiers. The default API rate limit is **60 requests per minute**, but this varies based on your subscription plan.
...
You might also want to check what your peak usage is for a given time period. You can do this in the [analytics page](https://dash.moderationapi.com/analytics) in your dashboard. Check the Peak RPM chart. This is useful to see if you are close to hitting your rate limit.
