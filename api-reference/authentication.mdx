...
The Moderation API uses [API keys](/content-moderation/manage-api-key) to authenticate requests. You can view and manage your API keys in your [Dashboard](https://moderationapi.com/app) under each project.
