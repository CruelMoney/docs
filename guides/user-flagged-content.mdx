...
<Frame>
  <img
    className="block"
    src="/guides/images/create-removal-action.png"
    alt="Creating a Removal Action"
  />
</Frame>
...
```typescript:/lib/profile/create.ts
...
```typescript:/lib/profile/update.ts
import { moderationApi } from "./lib/moderation";
import db from "./lib/db";
...
<Frame>
  <img
    className="block"
    src="/guides/images/queue-overview.png"
    alt="Queue Overview"
  />
</Frame>
