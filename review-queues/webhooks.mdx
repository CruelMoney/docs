...
If your application uses Cloudflare, you may need to whitelist our webhooks to ensure that our webhook calls can reach your server successfully. Without proper whitelisting, Cloudflare may block our webhook requests, preventing your application from receiving important notifications about queue events.

### Whitelisting webhooks by User-Agent (Recommended)

The recommended approach is to whitelist our User-Agent string, as this method remains stable even if our IP addresses change:
...
3. **Ensure your firewall rules** don't conflict with the whitelist
