...
You can set up webhooks for common events and actions from the [moderation queue](/review-queues/overview). This is useful if you want to integrate the queue with your own systems. Webhooks are configured under [actions in your dashboard](https://dash.moderationapi.com/project/latest/configure/actions)<br></br>
...
<ResponseField name="item" type="Item Object" required>
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="conversationId" type="string">
      The conversation id of the content item. Specified by you when sending the
      content for [moderation](/api-reference). _(Formerly `contextId`)_
    </ResponseField>
...
The signature is a `HMAC SHA256` hash of the payload using your webhook secret as the key. Find you webhook secret under [API Keys in your dashboard](https://dash.moderationapi.com/project/latest/configure/api-keys).
