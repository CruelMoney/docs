...
<Steps>
  ...
  <Step title="Take actions">
    ...
    actions on the content, such as approving or rejecting it.
  </Step>
  <Step title="Resolve content">
    The goal is to resolve all content in the queue. Once all content is
    resolved, the queue is empty.
  </Step>
</Steps>
