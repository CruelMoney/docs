...
Context is crucial in content moderation. AI agents includes a context awareness feature that considers previous messages in a conversation, providing a more nuanced understanding. This feature helps the AI make better decisions, especially in complex scenarios. Read about [context awareness](/content-moderation/submit-content#context-awareness) for more information about enabling context awareness.
