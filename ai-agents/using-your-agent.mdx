...
After you've created an agent, the model will show up alongside all the pre-built models in your project, and you can [add it like any other model](/content-moderation/adding-models).
