...
When a model training has completed, the model will show up alongside all the ready-made models in your project, and you can [add it like any other model](/content-moderation/adding-models).

### Response signature

Custom models have a similar response signature to the [ready-made classifiers](/models/classifier-overview).
