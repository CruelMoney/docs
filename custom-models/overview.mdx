...
Custom models are self-learning, which means that they will improve over time as you use them. This is done by using the [content queue](/content-queues) and correcting the model when it makes a mistake.
